...
import poster from '../assets/ArtOfYourPoster.jpeg'
        ...
        <img src={codemaniaPoster} style={{display:'flex',justifyContent:'center',width:'20%',margin:'auto'}}/> */}
                <Grid container>
                    <Grid item xs={6}>
                        ...
                        <h1 style={{ color: '#fff', marginLeft: '20%', fontFamily: 'Gotham', letterSpacing: '.2rem', fontSize: '400%' }}>Art Of Yours</h1>
                        <br /><br />
                    ...
                    <Grid item xs={6}>
                        ...
                        <button onClick={handleRegistration} className='register' type='submit' style={{marginTop:'42%'}}>Register</button>
                    </Grid>
                </Grid>
            </div>
        </div>
