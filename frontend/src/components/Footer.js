    ...
    <div className='footer' style={{margin:'0px',padding:'0px'}}>
      <Grid container>
        ...
        <Grid item xs={4} >
            ...
            <Link to='/events' className={classes.link}>Events</Link><br/><br/>
            <Link to='/contact' className={classes.link}>Contact Us</Link><br/><br/>
        ...
        <Grid item xs={4}>
            ...
            <Typography><FacebookIcon style={{color:'#fff',cursor:'pointer'}}  sx={{ fontSize: '50px' }} onClick={handleClick2}/></Typography>
        </Grid>
      </Grid>
    </div>
    </>
